          ...
          <div className="lg:col-span-5 space-y-4">
            {data.map((explorer) => (
              <div
                ...
                className={`group cursor-pointer p-6 rounded-2xl transition-all font-sans duration-300 border flex gap-4 items-center ${
                  ...
                  <div className="flex items-center justify-between">
                    <h3
                      className={`text-lg font-bold truncate transition-colors ${
                        activeExplorer.id === explorer.id ? "text-green-400" : "text-white group-hover:text-green-400"
                      }`}
                    >
                      {explorer.name}
                    </h3>
                  </div>
                  <p className="text-gray-400 text-xs truncate mt-0.5">{explorer.role}</p>
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 pb-6 border-b border-white/5">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-green-400 text-sm font-sans font-medium">{activeExplorer.role}</p>
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    {activeExplorer.createdContent.map((content) => {
                      // Get Content Icon
                      let Icon = ImageIcon;
                      ...
                      const handleContentClick = (e: React.MouseEvent) => {
                        if (isVideo) {
                          ...
                          setActiveVideoCreator(activeExplorer.name);
                          setIsVideoOpen(true);
                        }
                      };
