...
export default function EditProfilePage() {
  ...
  return (
    <main className="bg-[#020402] min-h-screen text-white font-sans selection:bg-green-500 selection:text-black relative overflow-hidden pb-20">
      <DashboardNavbar />
      ...
      <div className="md:pl-64">
        <div className="container mx-auto px-6 md:px-12 py-12 max-w-3xl z-10 relative">
