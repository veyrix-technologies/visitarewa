export const destinations = [
  ...
  },
  {
    ...
    fullDescription: "Yankari Game Reserve is the crown jewel of Nigerian eco-tourism and arguably the most significant wildlife sanctuary in West Africa. Spanning over 2,244 square kilometers of pristine Sudan Savannah, the reserve was originally created as a game preservation area in 1956 and later upgraded to a national park. It serves as a vital refuge for Nigeria's remaining megafauna, hosting the largest surviving elephant population in the country.\n\nA safari through Yankari offers the chance to see a breathtaking array of wildlife, including African bush elephants, olive baboons, patas monkeys, roan antelopes, and occasionally, the elusive West African lion. The landscape is a mix of rolling hills, woodland savanna, and vital river networks that sustain the ecosystem during the intense dry seasons.\n\nHowever, the absolute highlight for many visitors is the Wikki Warm Springs. Filtered through limestone rocks, the spring water is remarkably crystal clear, boasting a vibrant turquoise hue, and remains at a constant, soothing 31°C (88°F) year-round. After a long, dusty safari, swimming in the warm, naturally purified waters of the Wikki Spring under the canopy of ancient trees is an experience unlike any other.",
  ...
  },
  {
    ...
    highlights: ["Highest Peak in Nigeria (Chappal Waddi)", "Highland Tea Farms", "Cool Temperate Weather", "Stunning Waterfalls"],
...
export const events = [
  ...
  },
  {
    ...
    image: "/images/city-fiesta-0.webp",
...
export const people = [
  {
    ...
    fullDescription: "Aliko Dangote is not just a businessman; he is a visionary who fundamentally transformed Nigeria's entrepreneurial and industrial landscape. Born into a prominent mercantile family in Kano State, his business acumen was evident from a young age. What started as a modest trading firm in 1977—financed by a small loan from his grandfather—has since exploded into the Dangote Group, an immense, pan-African multi-trillion-naira conglomerate.\n\nHis investments span critical sectors of the African economy, including cement manufacturing, sugar refining, flour milling, and real estate. Most recently, the completion of the Dangote Refinery in Lagos stands as one of the most ambitious engineering and economic projects in modern African history, aiming to secure energy independence for the continent.\n\nBeyond his immense wealth, Dangote's legacy is tied to his profound impact on job creation and philanthropy. The Aliko Dangote Foundation (ADF) works tirelessly across Northern Nigeria and the continent to eradicate polio, fight severe acute malnutrition, and empower local female entrepreneurs. His life story is the ultimate testament that a child of Arewa can build an empire that rivals the largest global corporations.",
    image: "/images/dangote.jpg",
    gallery: ["/images/dangote.jpg"],
    achievements: ["Africa's Largest Industrial Conglomerate", "Wealthiest Black Person Globally", "Founder, Dangote Refinery", "Major Philanthropist via ADF"],
    ...
    socials: { twitter: "https://twitter.com/AlikoDangote", instagram: "https://www.instagram.com/aliko_dangotegcon" }
  },
  {
    id: 2,
    slug: "ali-nuhu",
    ...
    fullDescription: "Ali Nuhu is universally recognized as 'Sarki' (The King) of Kannywood, the Hausa-language film industry headquartered in Kano. With a staggering filmography exceeding 500 movies, he is undisputedly the most decorated and recognizable actor ever to emerge from Northern Nigeria. His ability to seamlessly transition between intense dramatic roles and charismatic romantic leads has earned him a fanatic, continent-wide fan base.\n\nWhat truly sets Ali Nuhu apart, however, is his role as a cultural bridge. For years, the Hausa cinema industry operated entirely independently from the mainstream Southern Nigerian film industry (Nollywood). Ali Nuhu broke that barrier, starring in major Nollywood blockbusters and bringing the elegance, language, and storytelling of the North to the global stage.\n\nToday, as a director and the founder of FKD Productions, he mentors the next generation of Arewa actors. He has used his massive platform not just for entertainment, but to advocate for education, peace, and youth empowerment across the Northern states.",
    image: "/images/ali.jpg",
    gallery: ["/images/ali.jpg"],
    achievements: ["500+ Films Starring Role", "Multiple National & International Awards", "Kannywood-Nollywood Bridge Builder", "Founder, FKD Productions"],
    ...
    socials: { instagram: "https://www.instagram.com/realalinuhu", twitter: "https://twitter.com/alinuhu" }
  },
  {
    id: 3,
    slug: "dj-abba",
    ...
    fullDescription: "DJ Abba (born Haruna Abdullahi) represents the explosive new wave of Northern Nigerian youth culture—a generation utterly unafraid to innovate while deeply respecting their linguistic roots. Emerging from the vibrant streets of Kaduna, he quickly transitioned from a local mixtape DJ to a phenomenal rapper, producer, and pop icon. \n\nHis genius lies in his ability to fuse traditional Hausa vernacular with contemporary hip-hop, trap, and Afrobeats. By rapping fluently in Hausa over high-energy, modern instrumentals, DJ Abba gave Northern youth a modern sound they could finally claim as entirely their own. His tracks dominate the airwaves from Kano to Lagos, and his electrifying stage presence has made him a festival headliner across the continent.\n\nAs the founder of the 'YNS' (Yaran North Side) movement, he is a cultural force. He has proved that an artist does not need to abandon their native tongue or cultural identity to achieve mainstream, commercial success in the highly competitive African music industry.",
    image: "/images/ab.jpg",
    gallery: ["/images/ab.jpg"],
    achievements: ["Northern Nigeria Music Pioneer", "Founder of YNS Movement", "Multiple Platinum Records", "Pan-African Collaborations"],
    ...
    socials: { instagram: "https://www.instagram.com/dj_abba", twitter: "https://twitter.com/dj_abba" }
  },
  {
    id: 4,
    slug: "maryam-bukar",
    ...
    fullDescription: "Maryam Bukar, known globally by her stage name 'Alhanislam', is a spoken-word poet whose voice commands both thunderous applause and profound silence. As the daughter of legendary Hausa actress Hauwa Maina, storytelling runs in her blood. However, Maryam chose the microphone over the camera, utilizing the ancient Northern tradition of oral poetry to speak truth to modern power.\n\nHer performances are hypnotic. Whether she is performing at the United Nations, massive literary festivals in Lagos, or international stages in London, she delivers the Northern narrative with staggering emotional depth. Her verses confront difficult socio-political realities, advocate for the rights of the girl-child, and weave together themes of Islamic faith, African heritage, and contemporary struggle.\n\nBeyond the stage, she is the founder of 'Deen-at-Heart', an initiative aimed at moral and spiritual reawakening for Muslim youth. Alhanislam is living proof that words, when spoken with conviction and grace, have the power to shift culture and ignite revolutions of the mind.",
    image: "/images/maryam.jpeg",
    gallery: ["/images/maryam.jpeg"],
    achievements: ["International Spoken Word Recognition", "Founder, Deen-at-Heart", "Global Stage Performances", "Advocate for Girl-Child Education"],
    ...
    socials: { instagram: "https://www.instagram.com/alhanislam", twitter: "https://twitter.com/alhanislam" }
  },
  {
    id: 5,
    slug: "rahama-sadau",
    ...
    fullDescription: "Rahama Sadau is the definition of a boundary-breaker. Born and raised in Kaduna State, she entered the Kannywood film industry and almost instantly rose to unprecedented stardom due to her undeniable charisma, acting prowess, and fierce independence. She quickly became the face of a modern, ambitious Northern woman.\n\nRefusing to be boxed into a single industry, Rahama expanded her horizons, transitioning seamlessly into mainstream Nollywood blockbusters and eventually securing prominent roles in international Bollywood productions. Her ability to navigate multiple cinematic universes while proudly maintaining her Arewa identity has inspired millions of young girls across the North.\n\nBeyond acting, she is a formidable entrepreneur and the founder of Sadau Pictures, an independent production company dedicated to telling high-quality, authentic Northern stories. Despite facing numerous cultural controversies throughout her career, her resilience, grace, and undeniable talent have cemented her as a global icon and a true pioneer of modern African cinema.",
    image: "/images/rahama.jpg",
    gallery: ["/images/rahama.jpg"],
    achievements: ["Nollywood & Bollywood Success", "Founder, Sadau Pictures", "International Film Recognition", "Global Brand Ambassador"],
    ...
    socials: { instagram: "https://www.instagram.com/rahamasadau", twitter: "https://twitter.com/Rahma_sadau" }
  },
  // {
  //     id: 6,
  //     slug: "classiq",
  //     name: "ClassiQ",
  //     title: "CLASSIQ",
  //     role: "THE HAUSA HIP-HOP KING",
  //     origin: "Bauchi, Nigeria",
  //     category: "MUSIC",
  //     shortDescription: "The undisputed 'Arewa Mafia' boss. He single-handedly revolutionized Hausa rap, blending fierce lyrical flow with unapologetic cultural pride.",
  //     fullDescription: "Buba Barnabas Luka, famously known as ClassiQ, is the architect of the modern Hausa hip-hop movement. Dubbed the 'Arewa Mafia', ClassiQ broke into the Nigerian music scene with a ferocity that demanded attention. At a time when mainstream Nigerian music was entirely dominated by English, Pidgin, and Yoruba, ClassiQ insisted on rapping in fluent, rapid-fire Hausa—and he did it better than anyone else.\n\nHis lyrical dexterity is unmatched. He weaves complex metaphors, street slang, and traditional proverbs into hard-hitting trap beats, creating a sound that is both deeply rooted in Northern culture and globally competitive. His collaborations with industry giants like MI Abaga and Vector solidified his status not just as a 'Northern rapper', but as one of the finest lyricists on the African continent.\n\nClassiQ is more than an artist; he is a movement. He gave Northern youth the confidence to embrace their language in popular culture, proving that Hausa is a language of poetry, power, and rhythm.",
  //     image: "/images/classiq.jpg",
  //     gallery: ["/images/classiq.jpg"],
  //     achievements: ["Pioneer of Modern Hausa Rap", "Headliner for Major Nigerian Festivals", "Critically Acclaimed Lyricist", "Cultural Music Ambassador"],
  //     quote: "Hausa is not a limitation; it is my superpower.",
  //     highlights: ["Lyrical Dexterity", "Hausa Hip-Hop", "Cultural Representation", "Mainstream Crossovers"],
  //     socials: { instagram: "https://www.instagram.com/classiq", twitter: "https://twitter.com/ClassiQ" }
  // },
  // {
  //     id: 7,
  //     slug: "amina-mohammed",
  //     name: "Amina J. Mohammed",
  //     title: "AMINA J. MOHAMMED",
  //     role: "GLOBAL DIPLOMAT",
  //     origin: "Gombe, Nigeria",
  //     category: "LEADERSHIP",
  //     shortDescription: "The Deputy Secretary-General of the United Nations. A towering figure in global diplomacy, sustainable development, and climate action.",
  //     fullDescription: "Amina Jane Mohammed is a towering figure in global diplomacy and one of the most powerful women in the world. Born in Liverpool to a Nigerian herdsman and a British nurse, she was raised in Northern Nigeria and ultimately returned to dedicate her life to public service, sustainable development, and environmental action.\n\nBefore ascending to the global stage, she served as Nigeria's Minister of Environment, where she spearheaded monumental initiatives to combat climate change, tackle the shrinking of Lake Chad, and clean up the oil-polluted Ogoniland. Her brilliance, pragmatism, and fierce dedication to humanity led to her appointment as the Deputy Secretary-General of the United Nations in 2017.\n\nAt the UN, she has been the driving force behind the Sustainable Development Goals (SDGs), working tirelessly to eradicate poverty, advance gender equality, and combat the climate crisis. She remains a fiercely proud daughter of Arewa, proving that the highest echelons of global leadership are within reach of the Northern Nigerian girl-child.",
  //     image: "/images/amina.jpg",
  //     gallery: ["/images/amina.jpg"],
  //     achievements: ["Deputy Secretary-General of the UN", "Former Minister of Environment (Nigeria)", "Architect of the UN SDGs", "Global Climate Action Leader"],
  //     quote: "We must leave no one behind in our quest for a sustainable future.",
  //     highlights: ["Global Diplomacy", "Sustainable Development", "Climate Action", "Women's Empowerment"],
  //     socials: { twitter: "https://twitter.com/AminaJMohammed" }
  // },
  {
    id: 8,
    slug: "sabiqah-bello",
    ...
    achievements: ["Founder of TeenLead Workshop", "Podcast Producer - Voices of the Vulnerable", "Youth Development Facilitator", "Community Storyteller"],
    ...
    socials: { linkedin: "https://www.linkedin.com/in/sabiqah-bello-7a71891a7/", instagram: "https://www.instagram.com/sabiqahbello/" }
  },
  {
    id: 9,
    slug: "usman-click",
    ...
    origin: "Gombe, Nigeria",
    category: "TECHNOLOGY",
    shortDescription: "The visionary architect behind Visit Arewa. A Full-Stack Developer and Product Designer building the digital future of Arewa.",
    ...
    gallery: ["/images/usman.jpg"],
    achievements: ["Creator of Visit Arewa Platform", "Top-tier Software Engineer", "Top-tier Product Designer (UI/UX)", "Digital Innovation Lead"],
    ...
    socials: { linkedin: "https://www.linkedin.com/in/usman-click-70aa47247/", instagram: "https://www.instagram.com/usmaan_click/" }
  }
];
...
export const dishes = [
  {
    ...
    ingredients: ["Thinly sliced Beef", "Kuli-Kuli (Groundnut Cake)", "Ginger Powder", "Garlic Powder", "Dried Cayenne Pepper", "Vegetable Oil", "Salt & Seasoning"]
  },
  {
    id: 2,
    slug: "tuwo",
    ...
    ingredients: ["Soft Rice (Tuwo Rice)", "Ripe Pumpkin (Kabewa)", "Fresh Spinach (Alayahu)", "Groundnuts (Peanut Butter)", "Beef or Goat Meat", "Palm Oil", "Sorrel Seeds (Yakuwa)", "Locust Beans (Dawadawa)"]
  },
  {
    id: 3,
    slug: "fura",
    ...
    ingredients: ["Millet Flour", "Fermented Cow Milk (Nono)", "Ginger Cloves", "Dried Chili Pepper", "Sugar", "Water", "Calabash (for serving)"]
  },
  {
    id: 4,
    slug: "waina",
    ...
    ingredients: ["White Rice (soaked overnight)", "Yeast", "Sugar", "Potash (Kanwa)", "Vegetable Oil", "Onions", "Yaji (Suya Spice)"]
  }
];
...
export const languages = [
  {
    ...
    commonPhrases: [{ phrase: "Sannu", meaning: "Hello / Sorry" }, { phrase: "Na gode", meaning: "Thank you" }, { phrase: "Ina kwana?", meaning: "How was your night?" }, { phrase: "Lafiya lau", meaning: "I am fine" }],
  ...
  },
  {
    ...
    commonPhrases: [{ phrase: "Jabbama", meaning: "Welcome" }, { phrase: "Useko", meaning: "Thank you" }, { phrase: "Jam waali", meaning: "Good morning" }, { phrase: "No mbadaa?", meaning: "How are you?" }],
  ...
  },
  {
    ...
    fullDescription: "Kanuri is a remarkable Nilo-Saharan language that serves as the linguistic legacy of one of Africa's greatest pre-colonial states: the Kanem-Bornu Empire. This empire dominated the Lake Chad basin for over a millennium, and the Kanuri language carries the aristocratic and intellectual weight of that profound history.\n\nSpoken predominantly in Borno and Yobe states, Kanuri culture is synonymous with deep-rooted Islamic scholarship. For centuries, scholars from the Borno empire traveled as far as Cairo and Mecca, establishing the language as a medium of academic and religious prestige. The linguistic structure of Kanuri is unique, lacking gender pronouns but utilizing a complex tonal system that requires precise inflection to convey accurate meaning.\n\nCulturally, Kanuri is a language of elegance and intricate diplomacy. It is spoken during the grand durbars of the Shehu of Borno, woven into the lyrics of traditional Kanuri lute (Ganga) music, and used to narrate the legendary tales of ancient cavalries that once ruled the expansive sands of the Sahel.",
    speakers: "Around 5-10 million speakers",
    regions: ["Borno", "Yobe"],
    history: "Kanuri is historically associated with the mighty Kanem-Bornu Empire, which dominated the Lake Chad region for centuries.",
    culturalSignificance: "The language carries the history of Islamic scholarship, complex diplomatic structures, and trans-Saharan trade.",
    writingSystem: "Latin script & Ajami (Arabic script)",
    dialects: ["Yerwa", "Manga", "Suwurti"],
    commonPhrases: [{ phrase: "Nda wuye", meaning: "How are you?" }, { phrase: "Kele", meaning: "Good / Fine" }, { phrase: "Lale", meaning: "Welcome" }],
  ...
  },
  {
    ...
    fullDescription: "Nupe, also known as Nupenci, is a vibrant Volta-Niger language spoken largely along the fertile banks of the Niger River in the Middle Belt of Nigeria. The Nupe people are historically renowned across West Africa as master craftsmen, particularly in brass-smithing (extensively practiced in Bida), intricate glass-making, and wood carving. The language itself acts as the living repository of these ancient crafts.\n\nBecause the Nupe civilization is deeply riverine and agrarian, the language boasts an incredibly rich vocabulary surrounding fishing, river navigation, and the cultivation of rice and sugarcane. Nupe is highly tonal, where a slight shift in pitch can entirely alter the meaning of a word, making it a highly melodic and expressive language to listen to.\n\nTraditional Nupe festivals, accompanied by the thunderous Ndakogboya masquerades, rely entirely on Nupe chants and proverbs. It is a language of artisans, farmers, and fierce warriors whose kingdom once held massive influence over the entire Niger confluence.",
    speakers: "Approximately 1-2 million speakers",
    regions: ["Niger", "Kwara", "Kogi"],
    history: "The Nupe people formed a powerful, highly structured kingdom in the Middle Belt of Nigeria before the 19th century.",
    culturalSignificance: "Central to the identity of the Nupe people, renowned for their traditional brass-smithing, glass-making, and agrarian culture.",
    writingSystem: "Latin script",
    dialects: ["Bida", "Lafiagi", "Agaie", "Pategi"],
    commonPhrases: [{ phrase: "Okú", meaning: "Greetings" }, { phrase: "Lafiya", meaning: "Fine / Good" }, { phrase: "Kú ishé", meaning: "Well done" }],
  ...
  },
  {
    ...
    history: "Tiv is a Tivoid language of the Southern Bantoid family, with origins tracing back to the great Bantu migrations.",
    culturalSignificance: "Famous for its vibrant storytelling, communal values, and energetic traditional dances like the Swange.",
    writingSystem: "Latin script",
    dialects: ["Largely uniform (highly mutually intelligible across regions)"],
    commonPhrases: [{ phrase: "Msugh", meaning: "Thank you / Welcome" }, { phrase: "U ngu nena?", meaning: "How are you?" }, { phrase: "M ngu dedoo", meaning: "I am fine" }],
...
export const crafts = [
  ...
  // {
  //     id: 3,
  //     slug: "bida-brass-work",
  //     name: "Bida Brass & Copper Smithing",
  //     title: "THE MASTERS OF BRASS",
  //     region: "Bida, Niger State",
  //     category: "Metalwork",
  //     status: "Active Heritage",
  //     shortDescription: "The ancient Nupe art of transforming raw brass and copper into intricate, highly decorated vessels, jewelry, and royal ornaments.",
  //     fullDescription: "Bida, the capital of the Nupe Kingdom, is renowned across West Africa as the undisputed home of master metalworkers. For centuries, the royal brass smiths of Bida have possessed an almost magical ability to transform raw, unforgiving metal into delicate, highly ornate works of art.\n\nThe process begins in intensely hot, open-air furnaces. Artisans melt down scrap brass and copper, pouring the molten metal into clay molds. Once cooled, the true artistry begins. Using nothing more than rudimentary hammers, anvils, and sharp chisels, the smiths beat the metal into shape. They then spend days meticulously engraving complex geometric patterns, Arabic calligraphy, and traditional Nupe motifs onto the surface of the metal.\n\nHistorically, these artisans exclusively served the Etsu Nupe (the King), crafting royal staffs, ceremonial swords, and massive ornamental bowls used in royal weddings. Today, their work ranges from exquisite jewelry to decorative plates. Despite the intense physical labor and the threat of modern mass production, the rhythmic clinking of hammers on brass still echoes through the narrow streets of Bida every morning.",
  //     quote: "Fire melts the metal, but patience shapes the art. We do not just beat brass; we write our culture onto it.",
  //     image: "/images/bida.jpg",
  //     gallery: ["/images/bida.jpg"],
  //     history: "The brass-smithing tradition in Bida dates back centuries and is tightly controlled by specific families who pass the knowledge strictly from father to son. Historically, the guild enjoyed royal patronage, operating directly under the protection of the Etsu Nupe.",
  //     significance: "Bida brass work is highly symbolic, often used in dowries and royal ceremonies. It represents the height of pre-colonial Nupe industrial and artistic capability.",
  //     tools: ["Open Furnaces", "Anvils", "Hammers", "Engraving Chisels", "Clay Molds"],
  //     timeline: "Production: 3 days to several weeks per piece",
  //     contributor: { name: "Visit Arewa Editorial", email: "", region: "Niger", story: "Celebrating the rhythmic artistry of Nupe metalworkers." },
  //     submitted: "2026-05-15",
  //     featured: false,
  //     coordinates: "9.0833° N, 6.0167° E"
  // },
  // {
  //     id: 4,
  //     slug: "zaria-leatherwork",
  //     name: "Zaria Traditional Leatherwork",
  //     title: "ZARIA LEATHERWORK",
  //     region: "Zaria, Kaduna",
  //     category: "Leatherwork",
  //     status: "Active Heritage",
  //     shortDescription: "The intricate art of tanning and crafting world-class leather goods, historically famous across the Sahara as 'Moroccan Leather'.",
  //     fullDescription: "Northern Nigeria has long been one of the world's greatest, yet most unacknowledged, centers of leather production. The historic city of Zaria is at the heart of this ancient industry. For centuries, artisans in Zaria have perfected the complex art of tanning raw animal hides and transforming them into incredibly supple, durable, and highly dyed leather goods.\n\nThe process is painstaking and relies heavily on traditional knowledge. Hides are soaked in natural tanning agents, stretched, dried, and then dyed using brilliant natural pigments—most famously the striking red and green hues characteristic of Arewa leatherwork. Once prepared, master craftsmen cut and sew the leather into intricate geometric patterns, creating everything from the iconic Northern men's sandals (Malum-Malum), to poufs, bags, and highly decorated horse saddles used in the Durbar festivals.\n\nFascinatingly, during the height of the trans-Saharan trade, this exceptional leather was transported by camel caravans across the desert to North Africa, where it was sold to European merchants. For centuries, it was mistakenly branded globally as 'Moroccan Leather', despite originating in the tanning pits of Northern Nigeria. Today, the tanners of Zaria continue their craft, reclaiming their rightful legacy as master leatherworkers.",
  //     quote: "What the world called 'Moroccan Leather' was born in the pits of Zaria. Our hands have clothed emperors and adorned warriors.",
  //     image: "/images/leather.jpg",
  //     gallery: ["/images/leather.jpg"],
  //     history: "Zaria leatherwork was a major economic driver of the trans-Saharan trade network. The leather produced here was so highly regarded for its quality and vibrant dyes that it became a massive export commodity to North Africa and eventually Europe.",
  //     significance: "Beyond its economic history, the leatherwork is essential to Northern culture, providing the vibrant footwear, bags, and equestrian gear necessary for major cultural expressions like the Durbar festival.",
  //     tools: ["Tanning Pits", "Natural Dyes", "Cutting Knives", "Awls", "Stretching Frames"],
  //     timeline: "Production: 1–2 weeks from raw hide to finished product",
  //     contributor: { name: "Visit Arewa Editorial", email: "", region: "Kaduna", story: "Uncovering the true origins of the world's finest historical leather." },
  //     submitted: "2026-05-15",
  //     featured: false,
...
export const explorers: Explorer[] = [
  ...
  },
  {
    ...
    socials: {
      instagram: "https://instagram.com/abdulwanders",
      youtube: "",
      twitter: ""
    },
    createdContent: [
...
let memoryUsers: UserProfile[] = [...initialUsers];
let memorySubmissions: Submission[] = [...initialSubmissions];
let memoryRegistrations: Registration[] = [];

// Helper to check if we are in the browser
const isBrowser = typeof window !== "undefined";

// Clear out legacy localStorage cached tables to prevent stale overrides on load
if (isBrowser) {
  const legacyKeys = ["arewa_users", "arewa_submissions", "arewa_registrations"];
...
export const db = {
  ...
  getUsers: (): UserProfile[] => {
    ...
    if (isBrowser) {
      // 1. Apply user profile updates (e.g. edits to existing users)
      const storedUpdates = localStorage.getItem("arewa_user_updates");
      if (storedUpdates) {
        try {
          const userUpdates = JSON.parse(storedUpdates);
          usersList = usersList.map(u => userUpdates[u.uid] ? { ...u, ...userUpdates[u.uid] } : u);
        } catch (e) {
          console.error("Failed to parse user updates", e);
        }
      }

      // 2. Load dynamic sign-ups
      const storedDynamic = localStorage.getItem("arewa_dynamic_users");
      let dynamicUsers: UserProfile[] = [];
      if (storedDynamic) {
        try {
          dynamicUsers = JSON.parse(storedDynamic);
        } catch (e) {
          console.error("Failed to parse dynamic users", e);
        }
      }

      const staticUids = new Set(usersList.map(u => u.uid));
      const filteredDynamic = dynamicUsers.filter(du => !staticUids.has(du.uid));
      memoryUsers = [...usersList, ...filteredDynamic];
    } else {
  ...
  createUser: (user: UserProfile): UserProfile => {
    if (isBrowser) {
      ...
      if (!dynamicUsers.some(du => du.uid === user.uid) && !initialUsers.some(iu => iu.uid === user.uid)) {
        dynamicUsers.push(user);
        localStorage.setItem("arewa_dynamic_users", JSON.stringify(dynamicUsers));
      }
    }
    db.getUsers();
    return user;
  ...
  updateUser: (uid: string, updates: Partial<UserProfile>): UserProfile => {
    if (isBrowser) {
      const storedUpdates = localStorage.getItem("arewa_user_updates");
      let userUpdates: Record<string, Partial<UserProfile>> = {};
      if (storedUpdates) {
        try {
          userUpdates = JSON.parse(storedUpdates);
        } catch (e) { }
      }
      userUpdates[uid] = { ...(userUpdates[uid] || {}), ...updates };
      localStorage.setItem("arewa_user_updates", JSON.stringify(userUpdates));

      // Update dynamic list if it's there
      const storedDynamic = localStorage.getItem("arewa_dynamic_users");
      if (storedDynamic) {
        try {
          let dynamicUsers: UserProfile[] = JSON.parse(storedDynamic);
          const idx = dynamicUsers.findIndex(u => u.uid === uid);
          if (idx !== -1) {
            dynamicUsers[idx] = { ...dynamicUsers[idx], ...updates };
            localStorage.setItem("arewa_dynamic_users", JSON.stringify(dynamicUsers));
          }
        } catch (e) { }
      }
    ...
    const updated = allUsers.find(u => u.uid === uid);
    if (!updated) {
  ...
  getSubmissions: (): Submission[] => {
    let subsList = [...initialSubmissions];
    if (isBrowser) {
      // 1. Apply content updates (e.g. edits to existing submissions)
      const storedUpdates = localStorage.getItem("arewa_submission_updates");
      if (storedUpdates) {
        try {
          const subUpdates = JSON.parse(storedUpdates);
          subsList = subsList.map(s => subUpdates[s.id] ? { ...s, ...subUpdates[s.id] } : s);
        } catch (e) {
          console.error("Failed to parse submission updates", e);
        }
      }

      // 2. Load dynamic user submissions
      const storedDynamic = localStorage.getItem("arewa_dynamic_submissions");
      let dynamicSubs: Submission[] = [];
      if (storedDynamic) {
        try {
          dynamicSubs = JSON.parse(storedDynamic);
        } catch (e) {
          console.error("Failed to parse dynamic submissions", e);
        }
      }

      // 3. Apply deletions
      const storedDeletions = localStorage.getItem("arewa_submission_deletions");
      let deletedIds = new Set<string>();
      if (storedDeletions) {
        try {
          deletedIds = new Set(JSON.parse(storedDeletions));
        } catch (e) { }
      }

      const staticIds = new Set(subsList.map(s => s.id));
      const filteredDynamic = dynamicSubs.filter(ds => !staticIds.has(ds.id) && !deletedIds.has(ds.id));
      memorySubmissions = [...subsList.filter(s => !deletedIds.has(s.id)), ...filteredDynamic];
    } else {
      memorySubmissions = subsList;
    }
  ...
  createSubmission: (submission: Submission): Submission => {
    if (isBrowser) {
      ...
      if (!dynamicSubs.some(s => s.id === submission.id) && !initialSubmissions.some(s => s.id === submission.id)) {
        dynamicSubs.unshift(submission);
        localStorage.setItem("arewa_dynamic_submissions", JSON.stringify(dynamicSubs));
      }
    }
    db.getSubmissions();
    return submission;
  ...
  updateSubmission: (id: string, updates: Partial<Submission>): Submission => {
    if (isBrowser) {
      const storedUpdates = localStorage.getItem("arewa_submission_updates");
      let subUpdates: Record<string, Partial<Submission>> = {};
      if (storedUpdates) {
        try {
          subUpdates = JSON.parse(storedUpdates);
        } catch (e) { }
      }
      subUpdates[id] = { ...(subUpdates[id] || {}), ...updates };
      localStorage.setItem("arewa_submission_updates", JSON.stringify(subUpdates));

      // Update dynamic list if it's there
      const storedDynamic = localStorage.getItem("arewa_dynamic_submissions");
      if (storedDynamic) {
        try {
          let dynamicSubs: Submission[] = JSON.parse(storedDynamic);
          const idx = dynamicSubs.findIndex(s => s.id === id);
          if (idx !== -1) {
            dynamicSubs[idx] = { ...dynamicSubs[idx], ...updates };
            localStorage.setItem("arewa_dynamic_submissions", JSON.stringify(dynamicSubs));
          }
        } catch (e) { }
      }
    ...
    const updated = allSubs.find(s => s.id === id);
    if (!updated) {
  ...
  deleteSubmission: (id: string): void => {
    if (isBrowser) {
      ...
      if (storedDeletions) {
        try {
          deletedIds = JSON.parse(storedDeletions);
        } catch (e) { }
      }
      if (!deletedIds.includes(id)) {
        deletedIds.push(id);
        localStorage.setItem("arewa_submission_deletions", JSON.stringify(deletedIds));
      }
      ...
      if (storedDynamic) {
        try {
          let dynamicSubs: Submission[] = JSON.parse(storedDynamic);
          const filtered = dynamicSubs.filter(s => s.id !== id);
          localStorage.setItem("arewa_dynamic_submissions", JSON.stringify(filtered));
        } catch (e) { }
      }
    }
    db.getSubmissions();
  ...
  getRegistrations: (): Registration[] => {
    if (isBrowser) {
      const stored = localStorage.getItem("arewa_dynamic_registrations");
      if (stored) {
        try {
          memoryRegistrations = JSON.parse(stored);
        } catch (e) {
  ...
  createRegistration: (registration: Registration): Registration => {
    const regsList = db.getRegistrations();
    if (!regsList.some(r => r.id === registration.id)) {
      regsList.push(registration);
    }
    memoryRegistrations = regsList;
    if (isBrowser) {
      localStorage.setItem("arewa_dynamic_registrations", JSON.stringify(regsList));
    }
    return registration;
  }
};
